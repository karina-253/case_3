...
def day_1():
    ...
    match m:
        case 1:
            print("Пришло время делать выбор. Пойдёшь прогуляться на улице или нет?"
        ...
        case 4:
            ...
            match awns:
                case 1:
                 ...
                 e = -120
                 b, c, d = (0,) * 3
                 print("Тебе объяснили теорию и она стала намного лучше, "
                       "но на тебя напала очень сильная ностальгия и твоё состояние сильно упало")
                case 2:
                 a, c, d, e,b = (0,) * 5
